		...
		<form method="post" action="action.jsp" name="frm">
			...
			<table border="1" style="width: 70%;height:70%;text-align:center">
				...
				<tr>
					<td>과목명</td>
					<td>
						<input type="text" name="name" style="width:100%" value='<%=name %>'>
					</td>
				</tr>
				<tr>
					<td>학점</td>
					<td>
						<input type="text" name="credit" style="width:100%" value='<%=credit %>'>
					</td>
				</tr>
				<tr>
					<td>담당강사</td>
					<td>
						<select name='lecturer' style="width:100%">
							...
							<option value='4' <% if(lecturer.equals("4")) out.println("selected"); %>>최교수</option>
							<option value='5' <% if(lecturer.equals("5")) out.println("selected"); %>>우교수</option>
